export default function Home() {
  return (
    <div className="w-full text-3xl text-violet-500">
        ...
        <div class="mx-auto max-w-screen-xl px-4 py-32 lg:flex lg:h-screen lg:items-center">
          <div class="mx-auto max-w-xl text-center">
            ...
            <p class="mt-4 sm:text-xl sm:leading-relaxed">
              You've found the best one. Your ticket to customer happiness is
              here. HelpDesk helps uncomplicate this process, every step of the
              way—for customers, agents, and managers.
            </p>
            ...
            <div class="mt-8 flex flex-wrap justify-center gap-4">
              ...
              <a
                ...
                href="https://uniserveit.com/blog/why-is-help-desk-important-for-your-business#:~:text=An%20IT%20Help%20Desk%20is,are%20experiencing%20a%20technical%20problem."
                target="_blank"
                rel="noreferrer"
              >
                Learn More
