  ...
  return (
    <div className="flex h-auto items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="w-full max-w-md space-y-8">
        <div>
          <h1 className="text-slate-500">Admin Account: username- tharun@gmail.com ; password- passwordtharun</h1>
          <h1 className="text-slate-500">User Account: username- varun@gmail.com ; password- passwordvarun</h1>
